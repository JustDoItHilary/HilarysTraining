...
import static com.example.weexdemo.test.MyProgressBarUtils.checkColors;
import static com.example.weexdemo.test.MyProgressBarUtils.checkNotNull;
import static com.example.weexdemo.test.MyProgressBarUtils.checkPositive;
import static com.example.weexdemo.test.MyProgressBarUtils.checkPositiveOrZero;
import static com.example.weexdemo.test.MyProgressBarUtils.checkSpeed;
...
public class MyProgressDrawable extends Drawable implements Animatable{
    ...
    private MyProgressDrawable.Callbacks mCallbacks;
    ...
    private MyProgressDrawable(Interpolator interpolator,
                                   int sectionsCount,
                                   int separatorLength,
                                   int[] colors,
                                   float strokeWidth,
                                   ...
                                   boolean reversed,
                                   boolean mirrorMode,
                                   MyProgressDrawable.Callbacks callbacks,
...
//    }
    ...
    public void setCallbacks(MyProgressDrawable.Callbacks callbacks) {
        mCallbacks = callbacks;
    }
    ...
    /**
     * Builder for MyProgressDrawable! You must use it!
     */
    public static class Builder {
        ...
        private MyProgressDrawable.Callbacks mOnProgressiveStopEndedListener;

        public Builder(Context context) {
            initValues(context);
        }

        public MyProgressDrawable build() {
            if (mGenerateBackgroundUsingColors) {
                mBackgroundDrawableWhenHidden = MyProgressBarUtils.generateDrawableWithColors(mColors, mStrokeWidth);
            }
            MyProgressDrawable ret = new MyProgressDrawable(
                    mInterpolator,
                    mSectionsCount,
        ...
        private void initValues(Context context) {
            ...
            mSectionsCount = res.getInteger(R.integer.my_default_sections_count);
            mColors = new int[]{res.getColor(R.color.my_default_color)};
            mSpeed = Float.parseFloat(res.getString(R.string.my_default_speed));
            mProgressiveStartSpeed = mSpeed;
            mProgressiveStopSpeed = mSpeed;
            mReversed = res.getBoolean(R.bool.my_default_reversed);
            mStrokeSeparatorLength = res.getDimensionPixelSize(R.dimen.my_default_stroke_separator_length);
            mStrokeWidth = res.getDimensionPixelOffset(R.dimen.my_default_stroke_width);
            mProgressiveStartActivated = res.getBoolean(R.bool.my_default_progressiveStart_activated);
            mGradients = false;
        }

        public MyProgressDrawable.Builder interpolator(Interpolator interpolator) {
            checkNotNull(interpolator, "Interpolator");
            mInterpolator = interpolator;
            return this;
        }

        public MyProgressDrawable.Builder sectionsCount(int sectionsCount) {
            checkPositive(sectionsCount, "Sections count");
            mSectionsCount = sectionsCount;
            return this;
        }

        public MyProgressDrawable.Builder separatorLength(int separatorLength) {
            checkPositiveOrZero(separatorLength, "Separator length");
            mStrokeSeparatorLength = separatorLength;
            return this;
        }

        public MyProgressDrawable.Builder color(int color) {
            mColors = new int[]{color};
            return this;
        }

        public MyProgressDrawable.Builder colors(int[] colors) {
            checkColors(colors);
            mColors = colors;
            return this;
        }

        public MyProgressDrawable.Builder strokeWidth(float width) {
            checkPositiveOrZero(width, "Width");
            mStrokeWidth = width;
            return this;
        }

        public MyProgressDrawable.Builder speed(float speed) {
            checkSpeed(speed);
            mSpeed = speed;
            return this;
        }

        public MyProgressDrawable.Builder progressiveStartSpeed(float progressiveStartSpeed) {
            checkSpeed(progressiveStartSpeed);
            mProgressiveStartSpeed = progressiveStartSpeed;
            return this;
        }

        public MyProgressDrawable.Builder progressiveStopSpeed(float progressiveStopSpeed) {
            checkSpeed(progressiveStopSpeed);
            mProgressiveStopSpeed = progressiveStopSpeed;
            return this;
        }

        public MyProgressDrawable.Builder reversed(boolean reversed) {
            mReversed = reversed;
            return this;
        }

        public MyProgressDrawable.Builder mirrorMode(boolean mirrorMode) {
            mMirrorMode = mirrorMode;
            return this;
        }

        public MyProgressDrawable.Builder progressiveStart(boolean progressiveStartActivated) {
            mProgressiveStartActivated = progressiveStartActivated;
            return this;
        }

        public MyProgressDrawable.Builder callbacks(MyProgressDrawable.Callbacks onProgressiveStopEndedListener) {
            mOnProgressiveStopEndedListener = onProgressiveStopEndedListener;
            return this;
        }

        public MyProgressDrawable.Builder backgroundDrawable(Drawable backgroundDrawableWhenHidden) {
            mBackgroundDrawableWhenHidden = backgroundDrawableWhenHidden;
            return this;
        }

        public MyProgressDrawable.Builder generateBackgroundUsingColors() {
            mGenerateBackgroundUsingColors = true;
            return this;
        }

        public MyProgressDrawable.Builder gradients() {
            return gradients(true);
        }

        public MyProgressDrawable.Builder gradients(boolean useGradients) {
