	    ...
	    },
	    {
	      ...
	      "children": [
	        ...
	        },
	        {
	          ...
	          "append": "tree",
	          "repeat": {
	            "expression": function () {return this.mylist},
	            "value": "item"
	          },
	          "children": [
	            {
	                  ...
	                  "children": [
	                    {
	                      "type": "div",
	                      "repeat": {
	                        "expression": function () {return this.item.tab_items},
	                        "value": "tab"
	                      },
	                      "children": [
	                        {
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = {
	  data: function () {return {
	    ...
	    url: 'http://192.168.100.140:8080/test_yn/zhy/zhyTest/test',
	    list: [{ "id": "216",
	      "time": "2016-12-20",
	      "type": 2,
	      "content": {
	      ...
	      tab_items: [{ 'type': 1, 'tab': '有通知', 'background_color': '#66ddff' }, { 'type': 2, 'tab': '有消息', 'background_color': '#ffdd66' }] }, { "id": "217",
	      "time": "2016-12-20",
	      "type": 2,
	      "content": {
	        "id": "217",
	      ...
	      tab_items: [{ 'type': 1, 'tab': '有通知', 'background_color': '#66ddff' }, { 'type': 2, 'tab': '有消息', 'background_color': '#ffdd66' }, { 'type': 3, 'tab': '放假了', 'background_color': '#ffaaff' }] }, { "id": "218",
	      "time": "2016-12-20",
	      "type": 2,
	      "content": {
	        "id": "217",
	      ...
	      tab_items: [{ 'type': 1, 'tab': '有通知', 'background_color': '#66ddff' }, { 'type': 2, 'tab': '有消息', 'background_color': '#ffdd66' }, { 'type': 3, 'tab': '放假了', 'background_color': '#ffaaff' }, { 'type': 4, 'tab': '嗨皮了', 'background_color': '#99cc00' }] }, { "id": "219",
	      "time": "2016-12-20",
	      "type": 2,
	      "content": {
	        "id": "217",
	      ...
	      tab_items: [{ 'type': 1, 'tab': '有通知', 'background_color': '#66ddff' }, { 'type': 2, 'tab': '有消息', 'background_color': '#ffdd66' }, { 'type': 3, 'tab': '放假了', 'background_color': '#ffaaff' }, { 'type': 4, 'tab': '嗨皮了', 'background_color': '#99cc00' }] }, { "id": "220",
	      "time": "2016-12-20",
	      "type": 2,
	      "content": {
	        "id": "217",
	  ...
	  created: function created() {
	    ...
	    self.getData(self.url, function (retdata) {
	  ...
	  methods: {
	    getData: function getData(url, callback) {
	      console.log('ret:', url);
	      stream.fetch({ method: 'GET', url: url, type: 'json' }, function (ret) {
	    ...
	    getList: function getList(retdata) {
	      var self = this;
	      console.log('ret:', retdata.length);
