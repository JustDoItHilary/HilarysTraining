...
public class MyWXWebView implements MyIWebView{
    ...
    private MyIWebView.OnErrorListener mOnErrorListener;
    private MyIWebView.OnPageListener mOnPageListener;
    ...
    private void initWebView(WebView wv) {
        ...
        wv.setWebChromeClient(new WebChromeClient() {
            ...
            public void onProgressChanged(WebView view, int newProgress) {
                ...
                if (mOnPageListener != null) {
                    mOnPageListener.onPageChange(newProgress);
                }
            }
